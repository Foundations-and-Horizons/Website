...
export const metadata = {
  title: "FoundationWorks Warehouse | Foundations & Horizons",
};
    ...
    <>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-500 mb-12">
            We&apos;re putting the finishing touches on FoundationWorks Warehouse.
      ...
      <section className="py-12 px-4 bg-[#2a3db4] text-white text-center">
        <div className="max-w-2xl mx-auto">
          <p className="text-blue-100 mb-4">In the meantime, check out FoundationWorks Volunteers — available now.</p>
          <Link
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              Leave your details and we&apos;ll reach out when FoundationWorks Warehouse
